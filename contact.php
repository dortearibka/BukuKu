...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="masukkan no hp" class="box">
      <textarea name="message" class="box" placeholder="tulis pesan anda" id="" cols="30" rows="10"></textarea>
